...
public class MultiCampoMina : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public void setGameManager(MultiGameManager gameManager)
    {
